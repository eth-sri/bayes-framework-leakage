...
def options():
    ...
    parser.add_argument('--latent', action='store_true', help='Optimize the distance over the latent instead of the concrete image space.')
    
    # Reconstruction 
    parser.add_argument('--steps', default=None, type=int, help="Load model after k steps")
    parser.add_argument('--use_steps', action='store_true', help="Indicates whether we use steps or epochs as unit")
    return parser
