...
from inversefed.data.data_processing import _build_cifar100, _build_cifar10, _get_meanstd
...
def preprocess(opt, defs, valid=False, tiny=False):
    if opt.data == 'cifar100':
        ...
        trainset, validset = _build_cifar10('~/data/')
        ...
        if tiny:
            ...
            dataset_indices = dataset_indices[:12000]
