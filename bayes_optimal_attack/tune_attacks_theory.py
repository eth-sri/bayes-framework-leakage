...
if __name__ == "__main__":
    test_params = {
      'att_fac_start' : [1.0, 0.25, 0.5, 1.5, 2, 3],
      'attack_total_variation' : [0.1, 1.0, 10.0],
      'att_lr': [1.0, 0.5, 0.8, 1.2, 1.5],
      'exp_decay_factor': [0.98, 1.0, 0.95, 0.96, 0.97, 0.94],
      }
